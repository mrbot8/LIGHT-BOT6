...
////////////▶ Creador Guillermo Canal By Traxnox
...
console.log(chalk.greenBright("├"), chalk.keyword("magenta")("[ 📵Llamada recibida By LIGHT ]"), chalk.greenBright(callerId))
samu330.sendMessage(callerId, "Las llamadas no se permiten, *PORFAVOR LEE LAS REGLAS!* Te bloqueare😒😍😈🍒 Si No Quieres Que Te saque Del Grupo Suscribete ami canal by LIGHT", MessageType.text, {quoted: {key: {
fromMe: false,
...
samu330.on('chat-update', async(sam) => {
	...
	mess = {
			...
			only: {
    			...
    			ownerB: '[❗] ¡Este comando solo puede ser utilizado por el creador del bot! ❌\nOsea, Samu: wa.me/+543413024447, Habla con el para que pueda cambiar el numero del owner en este bot',
	...
	const fspam = {
		...
		"vcard": 'BEGIN:VCARD\n' +
    		'Version:3.0\n' +
    		'TEL;type=CELL;type=VOICE;waid=543413024447:+543413024447\n' +
...
message: { "imageMessage": { "mimetype": "image/jpeg","caption": `🥀LIGHT`, 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fdoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "documentMessage": { "title":"🔥 LIGHT Canal By LIGHT💓", 'jpegThumbnail': fs.readFileSync('./src/fake.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const floc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "locationMessage": { "caption":"🥀Guillermo Canal By Traxnox💞", 'jpegThumbnail': fs.readFileSync('./src/samyperry.png')}}
}
contextInfo: {
mentionedJid: [sender]}
const fliveLoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "liveLocationMessage": { "caption":"🍒 LIGHT By LIGHT🔥", 'jpegThumbnail': fs.readFileSync('./src/img.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fvid = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "videoMessage": { "caption":"🌺Canal by LIGHT🌺", 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const faud = {
...
break
case 'menu2':
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy By Traxnox*, Asistente de *Guillermo*!.\n\nAl parecer no estas registrado en _*By Traxnox*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
stc = `╭⸻⃞✫꯭𝙈꯭𝙀꯭𝙉꯭𝙐꯭✫⃞⸻╮
╰────ြ𝐒𝐭𝐢𝐜𝐤𝐞𝐫🃏
╭─────────────
│ *${prefix}sticker*
...
case 'menu1':
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Sam330*, Asistente de Guillermo By Traxnox!.\n\nAl parecer no estas registrado en _*Guillermo By Traxnox*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
...
uptime = process.uptime()
const Menu18 = `➫Guillermo Creador Del Bot.li
...
https://chat.whatsapp.com/EhWGnNcXNKCJfHbPOcLZjy


Si quieres tener este bot, y usar tu los comandos, ve como se instala aqui Y Suscribete:
...
case 'creador':
addFilter(from)
aud = fs.readFileSync('./audio/creador.ogg') 
samu330.sendMessage(from, aud, audio, {quoted: faud, mimetype: 'audio/mp4', ptt: true, duration: -999999, sendEphemeral: true}) 
break
case 'nani':
addFilter(from)
...
reply(`*🔍Busqueda realizada por* 🐉Guillermo🐉\n\n${nyangg}`)
addFilter(from)
break
			
case 'imagen':
assistant = fs.readFileSync('./src/assistant.jpg')
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Sam330*, Asistente de *By Traxnox*!.\n\nAl parecer no estas registrado en _*Guillermo*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
...
sendFileFromUrl(waifu.url, image, {quoted: fimg, caption: '💎 *Guillermo By Traxnox* 💠', sendEphemeral: true})
addFilter(from)
break
...
await sleep(300)
samu330.sendMessage(from, { degreesLatitude: `${ipbot.lat}`, degreesLongitude: `${ipbot.lon}`, name: '📌Búsqueda por Guillermo By Traxnox🐉', address : `${ipbot.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
await sleep(300)
/*NO CAMBIAR DATOS NI NOMBRES*/samu330.sendMessage(from, { degreesLatitude: `${ip.lat}`, degreesLongitude: `${ip.lon}`, name: '📌Búsqueda por Guillermo By Traxnox🐉', address : `${ip.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
- pkg install bash
- pkg install nodejs
- git clone https://github.com/Samu330/Guillermo By Traxnox
- cd Guillermo By Traxnox
- bash install.sh
...
sendFileFromUrl(twi.result[2].link, video, {quoted: fvid, caption: '🍒Guillermo By Traxnox💠', duration: 999999999})
addFilter(from)
break
...
sendFileFromUrl(ig.result, video, {quoted: fvid, caption: '🍒Guillermo By Traxnox💠', duration: 999999999})
addFilter(from)
break
...
reply(`*Doxeo de ${mentionUser} echo por Guillermo By Traxnox*
...
sendFileFromUrl(logo, image, {quoted: fimg, caption: '*🔥 𝘓𝘰𝘨𝘰𝘴 Guillermo By Traxnox 🔥*', sendEphemeral: true})
break
...
case 'spam':
if (!itsMe) return reply('Este comando es solo para Guillermo By Traxnox🪀')
arg1 = q
...
samu330.sendMessage(from, estetik, MessageType.video, {mimetype: 'video/mp4', duration : 999999999, filename: `estetod.mp4`, quoted: fvid, caption: 'Guillermo By Traxnox'})
break
			
case 'asupan':
url = `https://lindow-api.herokuapp.com/api/asupan?apikey=${apikey}`
asupan = await getBuffer(url)
samu330.sendMessage(from, asupan, MessageType.video, {mimetype: 'video/mp4', duration : 999999999,filename: `asupan.mp4`, quoted: fvid, caption: 'Guillermo By Traxnox'})
break
...
sendFileFromUrl(xv.mp4, video, {quoted: fvid, caption: `*🍒Guillermo By Traxnox💠*`})
addFilter(from)
break
...
samu330.sendMessage(from, thumb, MessageType.image, {caption: 'Guillermo By Traxnox'})
}
addFilter(from)
break
case 'fdeface':
...
fake = arg
wa.sendFakeStatus2(from, `Guillermo By Traxnox`, fake)
break
case 'term':
if (!itsMe) return reply('Este comando solo puede ser usado por Guillermo By Traxnox ⚙')
if (!arg) return
...
case 'public':
if (!isOwner && !itsMe) return await reply('Este comando solo puede ser usado por Guillermo By Traxnox ⚙')
...
buffer = fs.readFileSync(ran)
samu330.sendMessage(from, buffer, MessageType.image, {quoted: sam, caption: 'Guillermo By Traxnox'})
fs.unlinkSync(ran)
}
})
}
...
samu330.sendMessage(from, result, video, {quoted: ftoko, caption: 'Guillermo By Traxnox', mimetype: 'video/gif'})
...
samu330.sendMessage(from, fs.readFileSync('caras.jpg'), MessageType.image, {quoted: fimg, caption: '💠Guillermo By Traxnox💎'})
} else {
...
default:
if (body.startsWith(">")) {
if (!itsMe) return await reply('Este comando solo puede ser usado por *By Traxnox* ⚙')
